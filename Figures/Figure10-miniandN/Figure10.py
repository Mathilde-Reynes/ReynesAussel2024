...
VPY_3 = np.loadtxt('../../Data/PY_v_c_disconnected.txt')
VPY_2 = np.loadtxt('../../Data/PY_v_c_disconnected_N60.txt')
VPY_1 = np.loadtxt('../../Data/PY_v_c_disconnected_N20.txt')
VPY_4 = np.loadtxt('../../Data/PY_v_c_disconnected_mini120.txt')
VPY_5 = np.loadtxt('../../Data/PY_v_c_disconnected_mini140.txt')
VPY_6 = np.loadtxt('../../Data/PY_v_c_disconnected_mini170.txt')
...
ax[1].plot(time_s, VPY_2,color="tab:blue",linewidth=1.5)
...
ax[0].set_xlim([0,8])
ax[0].tick_params(axis='both', which='major', labelsize=30, width=2)
ax[1].plot(time_s, VPY_5,color="tab:blue",linewidth=1.5)
...
ax[1].set_xlim([0,8])
ax[1].tick_params(axis='both', which='major', labelsize=30, width=2)
ax[2].plot(time_s, VPY_6,color="tab:blue",linewidth=1.5)
