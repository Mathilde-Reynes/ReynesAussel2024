...
def figure_rawdata(fig_number,all_monitors,all_monitors_T, monitor_poisson):
    ...
    # Figure 9/10/11/19
    if fig_number in ["9-A1", "9-A2", "9-A3", "9-B1", "9-B2", "9-B3", "10-1", "10-2", "10-3", "11-1", "11-2", "19"]:
        folder_name = f"Figure {fig_number}"
        if not os.path.exists(folder_name):
            os.makedirs(folder_name)
        savetxt(os.path.join(folder_name, 'PYs_v.txt'), V2_PYs.v/mV)
    ...
    # Figure 16/S3
    if fig_number in ["16-A1", "16-A2", "16-A3", "16-A4", "16-B1", "16-B2", "16-B3", "16-B4", "16-B5", "16-B6", "16-B7"]:
        folder_name = f"Figure {fig_number}"
        if not os.path.exists(folder_name):
            os.makedirs(folder_name)
        savetxt(os.path.join(folder_name, 'PYs_v.txt'), V2_PYs.v/mV)
    ...
    # Figure 17/18
    if fig_number in ["17-A1","18-A1","17-A2","18-A2","17-A3","18-A3","17-B1","18-B1","17-B2","18-B2","17-B3","18-B3"]:
        folder_name = f"Figure {fig_number}"
        if not os.path.exists(folder_name):
            os.makedirs(folder_name)
